...
def dateRestrictions(fullList, students):
    ...
    while True:
        ...
        initialPrompt += f'Type "Y" for YES // Type "N" for NO // "Q" to QUIT  '
            ...
            while True: 
                ...
                for i in students:
                    if count != len(students):
                        print(count," == ",i.name, " -- ", 'StartDate: ',i.startDate, 'EndDate: ',i.endDate)
                    else:
                        break
                    count += 1
                ...
                studentSelection_prompt += f'or "Q" to Quit:  '
